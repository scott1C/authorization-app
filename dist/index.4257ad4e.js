...
window.addEventListener("load", (0, _question.Question).renderList);
form.addEventListener("submit", submitFormHandler);
modalButton.addEventListener("click", openModal);
input.addEventListener("input", ()=>{
    submitBtn.disabled = !(0, _utils.isValid)(input.value);
});
function submitFormHandler(e) {
    e.preventDefault();
    if ((0, _utils.isValid)(input.value)) {
        const question = {
...
},{}],"80L40":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Question {
    ...
    static renderList() {
        ...
        const html = questions.length ? questions.map(toCard).join("") : `<div class="mui--text-headline">You have not entered something, yet</div>`;
